...
import segmentation.pytorch_msssim_3D as msim3d
...
def msssim_loss(y_pred,y_true):
    ms_loss=1-msim3d.msssim3D(y_pred, y_true, normalize='relu')
    #print('loss (msssim): {:.5f}'.format(ms_loss))
    return ms_loss
